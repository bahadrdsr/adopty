...
{
    public class GetFosterConversationsQueryHandler : IRequestHandler<GetFosterConversationsQuery, List<ConversationSummaryDto>>
    {
        private readonly IUserAccessor _userAccessor;
        private readonly DataContext _context;
        private readonly IMapper _mapper;
        public GetFosterConversationsQueryHandler(DataContext context, IUserAccessor userAccessor, IMapper mapper)
        {
